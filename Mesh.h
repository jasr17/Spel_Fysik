...
inline float Mesh::triangleTest(float3 rayDir, float3 rayOrigin, float3 tri0, float3 tri1, float3 tri2) {
...
inline float Mesh::obbTest(float3 rayDir, float3 rayOrigin, float3 boxPos, float3 boxScale)
{
...
inline bool Mesh::findMinMaxValues()
{
	if (mesh.length() > 0) {
...
inline void Mesh::createBuffers()
{
	HRESULT check;
...
inline float3 Mesh::getBoundingBoxPos() const
{
...
inline float3 Mesh::getBoundingBoxSize() const
{
...
inline bool Mesh::loadMesh(string OBJFile, typeOfShading ToS)
{
...
inline float Mesh::castRayOnMesh(float3 rayPos, float3 rayDir)
{
...
inline Mesh::Mesh(string OBJFile, typeOfShading ToS)
{
